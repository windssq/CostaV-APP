          ...
          <div className="relative">
            <div className="flex flex-col lg:flex-row justify-between w-full p-6 px-8 items-center h-full">
              <div className="flex flex-col lg:justify-start justify-center items-center lg:items-start mt-5 lg:mt-0 w-full">
                ...
                İşte Aradığınız O Bot CostaV Aradığınız Tüm Herşey Benle Birlikte.İşte Bende Olan Özellikler---> -Moderasyon -Koruma -Kayıt -Ticket Sistemi -Özel Oda Sistemi -Level Sistemi & Daha Fazlası Sizler İle CostaV Sizleri Bekliyor
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="CostaV" src={`https://i.hizliresim.com/pn16m6p.jpg`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/windssq`+_.name}
                      target="_blank"
                      rel="noreferrer"
